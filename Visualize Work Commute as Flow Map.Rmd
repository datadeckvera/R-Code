...
Import and assign the SouthamptonOA shapefile as soton, import the centroids .csv and assign coordinates to to create centroids.obj object. Then we create the soton.df data frame by joining the soton shapefile to the centroids.obj object
